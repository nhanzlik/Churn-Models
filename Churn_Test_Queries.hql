...
from dev.venona_main_churn a FULL OUTER JOIN dev.venona_top_channel b on (a.account_guid=b.account_guid_tchannel)
FULL OUTER JOIN dev.venona_avg_std_channel c on (b.account_guid_tchannel=c.account_guid_schannel)  
LEFT JOIN dev.never_logged_in e on (e.account_guid_noLog=c.account_guid_schannel);
